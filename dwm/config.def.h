...
static const char *chromium[] = {"chromium", NULL};/* See LICENSE file for copyright and license details. */
...
static const char *print_screen_cmd[] = {"scrot", "%Y-%m-%d-%H%M%S.png", "-e",
                                         "mv $f ~/Pictures/screenshots", NULL};
