...
static const char *upvolume[]  = {"amixer", "-qM", "sset", "Master", "5%+", "unmute", NULL};
static const char *downvolume[]  = {"amixer", "-qM", "sset", "Master", "5%-", "unmute", NULL};
static const char *mutevolume[]  = {"amixer", "-qM", "sset", "Master", "toggle", NULL};
